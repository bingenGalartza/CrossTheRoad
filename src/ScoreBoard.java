...
public class ScoreBoard extends BasicGameState implements ComponentListener{
	...
	public static String EXIT = "res/play_again_button.png";
	...
	public static int EXIT_X = 320;
	public static int EXIT_Y = 641;
	...
	Image background,button,exit;
	TrueTypeFont font;
	TextField text;
	MouseOverArea bSubmit, bExit;
	FileManager manager;
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
		...
		bSubmit = new MouseOverArea(container,button,BUTTON_X,BUTTON_Y,this);
		bExit = new MouseOverArea(container,exit,EXIT_X,EXIT_Y,this);
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
		...
		bSubmit.render(container, g);
		bExit.render(container, g);
